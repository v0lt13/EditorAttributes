...
namespace EditorAttributesSamples
{
	...
	public class HorizontalGroupSample : MonoBehaviour
	{
		...
		[HorizontalGroup(nameof(intField01), nameof(stringField01), nameof(boolField01))]
		[SerializeField] private Void groupHolder;
		[Space]
		[HorizontalGroup(200f, 30f, true, nameof(intField02), nameof(stringField02), nameof(boolField02))]
