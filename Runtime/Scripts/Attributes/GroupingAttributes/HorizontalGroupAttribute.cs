...
namespace EditorAttributes
{
    ...
    public class HorizontalGroupAttribute : PropertyAttribute
    {
        ...
        /// <param name="fieldsToGroup">The name of the fields to group</param>
        public HorizontalGroupAttribute(bool drawInBox, params string[] fieldsToGroup) : this(fieldsToGroup) => DrawInBox = drawInBox;
        ...
        /// <param name="drawInBox">Draw the group in a nice box</param>
        /// <param name="fieldsToGroup">The name of the fields to group</param>
        public HorizontalGroupAttribute(float widthOffset = 0f, float propertySpace = 0f, bool drawInBox = false, params string[] fieldsToGroup) : this(drawInBox, fieldsToGroup)
        {
