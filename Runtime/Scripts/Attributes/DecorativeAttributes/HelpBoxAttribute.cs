...
namespace EditorAttributes
{
    ...
    public class HelpBoxAttribute : PropertyAttribute, IDynamicStringAttribute
    {
        ...
        public HelpBoxAttribute(string message, MessageMode messageType = MessageMode.Log, StringInputMode stringInputMode = StringInputMode.Constant, bool drawAbove = false) : base(true)
        {
            Message = message;
            DrawAbove = drawAbove;
