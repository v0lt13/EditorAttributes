...
namespace EditorAttributes
{
    public class TitleAttribute : PropertyAttribute, IDynamicStringAttribute
    {
		...
		public TitleAttribute(string title, int titleSize = 20, float titleSpace = 10f, bool drawLine = true, TextAnchor alignment = TextAnchor.MiddleLeft, StringInputMode stringInputMode = StringInputMode.Constant)
